...
namespace InvestCar.Controllers
{
    public class VeiculosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ModeloId,Placa,Chassis,Hodometro,Cor,AnoFab,AnoModelo,Origem,Renavam,ValorFipe,ValorPago,ValorVenda")] Veiculo veiculo)
        {
